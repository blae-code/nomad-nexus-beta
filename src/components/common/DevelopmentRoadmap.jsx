      ...
      {expanded && (
        <div className="space-y-3">
          ...
          {moduleGroups.active.length > 0 && (
            ...
            <div className="text-green-400 text-[8px]">Comms Array now ~95% complete with command system, templates, roster tools, DND, drafts, export history, and auto link previews</div>
            </div>
        </div>
      )}
      </div>
