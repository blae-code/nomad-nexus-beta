...
export const MODULE_STATUS = {
  ...
  CommsConsole: {
    ...
    features: [
      ...
      { name: 'Desktop Notifications', status: 'in-progress' },
      { name: 'Message Drafts', status: 'in-progress' },
      { name: 'Emoji Picker', status: 'in-progress' },
      ...
      { name: 'Link Previews', status: 'planned' },
