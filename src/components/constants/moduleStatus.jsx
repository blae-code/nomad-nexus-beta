...
export const MODULE_STATUS = {
  ...
  FleetTracking: {
    ...
    features: [
      ...
      { name: 'Telemetry Dashboard', status: 'complete' },
  ...
  FleetCommand: {
    ...
    features: [
      ...
      { name: 'Tactical Map', status: 'complete' },
  ...
  CommsConsole: {
    ...
    features: [
      ...
      { name: 'Discord Bridge Integration', status: 'in-progress' },
      ...
      { name: 'Video/Audio Messages', status: 'complete' },
    ],
  },
  CommandCenter: {
    name: 'Command Center',
    completed: 60,
    features: [
      { name: 'Order Issuance', status: 'complete' },
      { name: 'Acknowledgement Tracking', status: 'complete' },
      { name: 'Role/Net Targeting', status: 'complete' },
      { name: 'Command Feed', status: 'complete' },
      { name: 'Escalation Hooks', status: 'planned' },
    ],
  },
  MissionBoard: {
    name: 'Mission Board',
    completed: 55,
    features: [
      { name: 'Post Contracts', status: 'complete' },
      { name: 'Claim & Complete', status: 'complete' },
      { name: 'Reward Tracking', status: 'in-progress' },
      { name: 'Role Matching', status: 'planned' },
    ],
  },
  LogisticsHub: {
    name: 'Logistics Hub',
    completed: 55,
    features: [
      { name: 'Inventory Tracking', status: 'complete' },
      { name: 'Location Management', status: 'complete' },
      { name: 'Supply Status', status: 'in-progress' },
      { name: 'Transfer Workflows', status: 'planned' },
    ],
  },
  StrategicObjectives: {
    ...
    completed: 50,
    features: [
      { name: 'Objective Catalog', status: 'complete' },
      { name: 'Progress Updates', status: 'complete' },
      { name: 'Objective Ownership', status: 'planned' },
    ],
  },
  OnboardingPipeline: {
    ...
    completed: 45,
    features: [
      { name: 'Checklist Tracking', status: 'complete' },
      { name: 'Mentor Assignment', status: 'planned' },
      { name: 'Training Milestones', status: 'planned' },
    ],
  },
  HudMode: {
    name: 'HUD Mode',
    completed: 40,
    features: [
      { name: 'Second-Screen Layout', status: 'complete' },
      { name: 'Orders Feed', status: 'complete' },
      { name: 'Alert Feed', status: 'complete' },
      { name: 'HUD Customization', status: 'planned' },
    ],
  },
  HighCommand: {
    name: 'High Command',
