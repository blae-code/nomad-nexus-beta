      ...
      <div className="px-3 py-2 bg-zinc-900/50 border-b border-zinc-800 shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            {/* AI PTT Features - Only visible when AI is enabled */}
            {aiOptIn && (
              <>
                <div className="h-3 w-px bg-zinc-700" />
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        disabled={!aiOptIn}
                        className={cn(
                          'px-2 py-0.5 rounded text-[8px] font-mono transition-all flex items-center gap-1',
                      ...
                      >
                        ...
                        <span className="uppercase font-bold">TX</span>
                      </button>
                    </TooltipTrigger>
                    <TooltipContent side="bottom">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        ...
                        <span className="uppercase font-bold">INF</span>
                      </button>
                    </TooltipTrigger>
                    <TooltipContent side="bottom">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        ...
                        <span className="uppercase font-bold">AOM</span>
                      </button>
                    </TooltipTrigger>
                    <TooltipContent side="bottom">
