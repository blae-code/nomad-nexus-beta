  ...
  return (
    ...
    <div className="flex flex-col bg-zinc-950/50 rounded overflow-hidden">
      ...
      <div className="w-full border-t border-zinc-800 bg-zinc-900/50 py-2 space-y-1.5 px-3">
        {/* Keybind Hints */}
        <button 
          onClick={() => navigate(createPageUrl('CommsSettings'))}
          className="w-full text-[9px] text-zinc-200 font-mono flex items-center justify-center gap-4 whitespace-nowrap bg-zinc-800/30 hover:bg-zinc-800/60 py-1.5 rounded px-2 transition-colors cursor-pointer group"
          title="Click to configure keybindings"
        >
          ...
          <Settings className="w-3 h-3 text-zinc-500 opacity-0 group-hover:opacity-100 transition-opacity ml-1" />
        </button>
