  ...
  return (
    <div
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="px-3 flex-1 overflow-hidden flex flex-col gap-2">
          {commandFeedback &&
          <section 
            aria-live="polite" 
            className="nx-inline-feedback rounded-md border border-orange-500/40 bg-gradient-to-r from-orange-500/8 via-orange-600/5 to-orange-700/[0.02] px-3 py-2 text-[9px] text-orange-200 font-extrabold uppercase tracking-[0.16em] leading-none hover:border-orange-500/60 hover:from-orange-500/12 hover:via-orange-600/8 hover:to-orange-700/5 hover:shadow-[0_0_12px_rgba(249,115,22,0.15)] transition-all duration-200 shadow-[0_1px_8px_rgba(0,0,0,0.25)] backdrop-blur-sm relative overflow-hidden"
            style={{
              textShadow: '0 1px 3px rgba(0,0,0,0.5)',
            }}>
              <div className="absolute inset-0 bg-gradient-to-r from-orange-400/[0.03] via-transparent to-transparent opacity-50 pointer-events-none" />
              <div className="relative z-10">{commandFeedback}</div>
            </section>
          }
          <div className="flex-1 overflow-hidden nx-workbench-wrap nexus-panel-glow rounded-lg border border-zinc-800/60 bg-gradient-to-br from-zinc-950/65 via-zinc-900/45 to-zinc-950/60 hover:border-orange-500/50 hover:shadow-[0_0_24px_rgba(249,115,22,0.12),0_0_6px_rgba(249,115,22,0.08)_inset] transition-all duration-300 p-0 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.45),0_1px_8px_rgba(0,0,0,0.25)] relative overflow-hidden before:absolute before:inset-0 before:rounded-lg before:border before:border-white/[0.02] before:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:bg-gradient-to-br after:from-orange-500/[0.015] after:via-transparent after:to-zinc-900/[0.02] after:opacity-0 hover:after:opacity-100 after:transition-opacity after:duration-350 after:pointer-events-none">
            <div className="absolute top-0 left-0 right-0 h-[0.5px] bg-gradient-to-r from-transparent via-zinc-700/30 to-transparent opacity-60" />
            <div className="absolute bottom-0 left-0 right-0 h-[0.5px] bg-gradient-to-r from-transparent via-zinc-800/20 to-transparent opacity-40" />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(249,115,22,0.02),transparent_60%)] opacity-0 hover:opacity-100 transition-opacity duration-400 pointer-events-none" />
