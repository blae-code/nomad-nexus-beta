...
export const GameplayVariantRegistry: Readonly<GameplayVariantDefinition[]> = [
  ...
  {
    id: 'MINING_SHIP_SURFACE',
    loop: 'MINING',
    environment: 'Surface',
    defaultBridge: 'INDUSTRY',
    defaultCommsTemplateId: 'SQUAD_NETS',
    notes: 'Ship-based surface extraction with hauler shuttle loops and escort overwatch.',
  },
  {
    id: 'MINING_SHIP_MOON',
    loop: 'MINING',
    ...
    defaultBridge: 'INDUSTRY',
    defaultCommsTemplateId: 'SQUAD_NETS',
    notes: 'Ship-based extraction on moon surfaces where weather and visibility windows matter.',
  },
  {
    id: 'MINING_ROC_SURFACE',
    loop: 'MINING',
    environment: 'Surface',
    defaultBridge: 'INDUSTRY',
    defaultCommsTemplateId: 'SQUAD_NETS',
    notes: 'ROC convoy mining with geo-node scouting, line security, and recovery support.',
  },
  {
    id: 'MINING_HAND_CAVE',
    loop: 'MINING',
    ...
    notes: 'Hand mining in caves and bunkers with medevac readiness and extraction routing.',
  },
  {
    id: 'MINING_PLANETARY_RING',
    loop: 'MINING',
    environment: 'Space',
    defaultBridge: 'INDUSTRY',
    defaultCommsTemplateId: 'SQUAD_NETS',
    notes: 'Ring sweep mining where scan density, hostile risk, and refuel cadence dominate.',
  },
  {
    id: 'PVP_CQB_BOARDING',
    loop: 'PVP',
  ...
  {
    id: 'SALVAGE_COMPONENT_RECOVERY',
    loop: 'SALVAGE',
    environment: 'Space',
    defaultBridge: 'INDUSTRY',
    defaultCommsTemplateId: 'SQUAD_NETS',
    notes: 'Component-focused recovery where triage and storage discipline drive margins.',
  },
  {
    id: 'SALVAGE_CARGO_RECLAMATION',
    loop: 'SALVAGE',
    environment: 'Space',
    defaultBridge: 'LOGISTICS',
    defaultCommsTemplateId: 'SQUAD_NETS',
    notes: 'Cargo reclamation from wreck fields with rapid load-sort-dispatch cycles.',
  },
  {
    id: 'SALVAGE_SURFACE_WRECK_RECOVERY',
    loop: 'SALVAGE',
    environment: 'Surface',
    defaultBridge: 'INDUSTRY',
    defaultCommsTemplateId: 'SQUAD_NETS',
    notes: 'Surface wreck recovery requiring ground security and extraction route control.',
  },
  {
    id: 'SALVAGE_BLACKBOX_RETRIEVAL',
    loop: 'SALVAGE',
    environment: 'Interior',
    defaultBridge: 'INTEL',
    defaultCommsTemplateId: 'FIRETEAM_PRIMARY',
    notes: 'Interior salvage focused on critical data/blackbox capture and secure exfil.',
  },
  {
    id: 'HAULING_CONVOY',
    loop: 'HAULING',
