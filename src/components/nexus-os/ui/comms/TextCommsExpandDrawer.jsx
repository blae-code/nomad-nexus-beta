...
export default function TextCommsExpandDrawer({
  open,
  title,
  subtitle = '',
  count = 0,
  ...
  return (
    <div className="absolute inset-0 z-30 bg-black/80 backdrop-blur-sm flex flex-col">
      <header className="flex-shrink-0 px-3 py-2 border-b border-zinc-700/40 bg-zinc-900/70 flex items-center justify-between gap-2 nexus-top-rail">
