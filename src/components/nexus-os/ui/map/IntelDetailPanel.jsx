/**
 * IntelDetailPanel - Selected intel inspection and actions
 * 
 * DESIGN COMPLIANCE:
 * - Typography: headerPrimary (h4), bodyPrimary (content), telemetrySecondary (metrics)
 * - Spacing: p-2.5 (panel), gap-2 (standard)
 * - Borders: border-zinc-800 (standard), border-zinc-700 (inputs)
 * - Primitives: NexusBadge, NexusButton, RustPulseIndicator
 * 
