...
export default function ThreadPanel({ parentMessage, onClose, currentUserId, isAdmin, composerDisabled, composerDisabledReason, autoLinkPreview = true, aiEnabled = true }) {
