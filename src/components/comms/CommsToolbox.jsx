...
import CommsMonitor from "@/components/comms/CommsMonitor";
import NetPatchControl from "@/components/comms/NetPatchControl";
  ...
  return (
    <aside className="w-80 border-l border-zinc-800 bg-zinc-950 flex flex-col h-full">
       ...
       <div className="flex-1 flex flex-col gap-6 p-4 overflow-hidden overflow-y-auto custom-scrollbar">
          ...
          {/* Net Patch Control */}
          {eventId && <NetPatchControl eventId={eventId} user={user} />}

          {/* AI Comms Monitor */}
          {eventId && <CommsMonitor eventId={eventId} autoRefresh={true} />}
