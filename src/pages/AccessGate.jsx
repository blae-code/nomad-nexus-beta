        ...
        <div className="border-2 border-orange-500/50 bg-zinc-950/85 backdrop-blur-xl p-0 overflow-hidden shadow-2xl shadow-orange-500/20 glow-box">
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="space-y-2.5 group">
              ...
              <div className="relative">
                <Input
                  ...
                  className="uppercase tracking-wider text-center h-12 bg-zinc-900/60 border-2 border-emerald-500/30 group-focus-within:border-emerald-500/60 group-focus-within:bg-zinc-900 focus:border-emerald-500/60 focus:bg-zinc-900 text-zinc-100 placeholder:text-zinc-600 transition-all duration-200"
                  onKeyDown={(e) => e.key === 'Enter' && handleRedeem()}
                />
                <div className="absolute -inset-1 border border-emerald-500/0 group-focus-within:border-emerald-500/20 rounded transition-all duration-200 pointer-events-none" />
              </div>
            </div>
            ...
            <Button
              ...
              className="w-full h-12 mt-8 bg-gradient-to-r from-purple-600 via-purple-500 to-purple-600 hover:from-purple-500 hover:via-purple-400 hover:to-purple-500 text-white font-bold uppercase tracking-widest disabled:opacity-40 disabled:cursor-not-allowed shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 transition-all duration-200 relative overflow-hidden group"
            >
